...
pub(super) fn web_console_serves_index_and_graph_api() {
    ...
    assert!(metrics.contains("\"db_nodes\""));
    assert!(metrics.contains("\"db_committed_indexes\""));
    assert!(metrics.contains("\"db_applied_indexes\""));
    assert!(metrics.contains("\"db_shard_count\""));
    assert!(metrics.contains("\"index_ready_count\""));
    assert!(metrics.contains("\"tenant_database_count\""));
    assert!(metrics.contains("\"raft_group_count\""));
    assert!(metrics.contains("\"raft_term_max\""));
