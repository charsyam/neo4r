...
grep -q "previous-release-fixture-compat" docs/rolling_upgrade_manifest.yml
...
cargo test -p neo4r-server upgrade_compatibility_plan_requires_rollback_and_previous_fixture --quiet
