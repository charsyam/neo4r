...
grep -q "neo4r_slo_query_error_rate_ppm" crates/neo4r-server/src/backend/backend_web_query_backup.rs
grep -q "neo4r_slo_burn_rate_ppm" crates/neo4r-server/src/backend/backend_web_query_backup.rs
grep -q "neo4r_database_slo_burn_rate_ppm" crates/neo4r-server/src/backend/backend_web_query_backup.rs
grep -q "Neo4rSloBurnRateHigh" docs/prometheus_alerts.yml
