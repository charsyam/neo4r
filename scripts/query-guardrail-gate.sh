...
grep -q "resource_pressure_rejects_before_execution" docs/query_guardrails.yml
...
cargo test -p neo4r-server resource_pressure_rejects_memory_disk_and_cpu_pressure --quiet
